...
while ( have_posts() ) { the_post();
	...
	?><article id="post-<?php the_ID(); ?>" <?php post_class( 'team_member_page itemscope' ); trx_addons_seo_snippets('', 'Article'); ?>><?php
		...
		?><div class="team_member_header"><?php
			...
			?><div class="team_member_description"><?php
				...
				<div class="team_member_details">
					<?php
					$override_options = trx_addons_meta_box_get(get_post_type());
				...
				if (!empty($meta['brief_info'])) {
					...
					<div class="team_member_brief_info">
						<h5 class="team_member_brief_info_title"><?php esc_attr_e('Brief info', 'fcunited'); ?></h5>
