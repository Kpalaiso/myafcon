...
if ( ! function_exists( 'fcunited_customizer_get_css' ) ) {

	function fcunited_customizer_get_css( $args = array() ) {
		...
		if ( $fonts ) {
			...
			$fonts = fcunited_customizer_add_theme_fonts( $fonts );
...
CSS;
			$rez          = apply_filters( 'fcunited_filter_get_css', $rez, array( 'fonts' => $fonts ) );
			$css['fonts'] = $rez['fonts'];
		}
		...
		if ( $vars ) {
			...
			// Make theme-specific fonts rules
			$vars = fcunited_customizer_add_theme_vars( $vars );
			extract( $vars );
...
CSS;
			$rez          = apply_filters( 'fcunited_filter_get_css', $rez, array( 'vars' => $vars ) );
			$css['vars']  = $rez['vars'];
		}
		...
		//--------------------------------------
		if ( false !== $colors ) {
			$schemes = empty( $scheme ) ? array_keys( fcunited_get_sorted_schemes() ) : array( $scheme );
			...
			if ( count( $schemes ) > 0 ) {
				...
				foreach ( $schemes as $s ) {
					// Prepare colors
					if ( empty( $scheme ) ) {
						$colors = fcunited_get_scheme_colors( $s );
					}

					// Make theme-specific colors and tints
					$colors = fcunited_customizer_add_theme_colors( $colors );
...
.wp-caption-overlay .wp-caption .wp-caption-dd {
	...
	background: {$colors['bg_color_08']} !important;
}
ul > li:before {
	color: {$colors['text_link']};
}
...
.widget_search form:hover:after, form.wp-block-search:after,
...
.single-post .wp-block-search .wp-block-search__button.has-icon svg {
...
.woocommerce footer .select_container:after {
	color: {$colors['input_text']};
}
.woocommerce .select_container:after {
	color: {$colors['input_dark']};
}
.woocommerce .select_container:focus:after,
.woocommerce .select_container:hover:after {
	color: {$colors['text_link']};
}
...
.woocommerce footer .select_container:focus:after,
.woocommerce footer .select_container:hover:after{
	color: {$colors['inverse_link']};
}
.select_container select {
	color: {$colors['input_text']};
...
div .sp-template .sp-view-all-link > a *,
...
input[type="button"][disabled]:hover {
	background-color: {$colors['text_dark_04']} !important;
	color: {$colors['bg_color']} !important;
}
...
.woocommerce input[type="submit"]:hover, .woocommerce-page input[type="submit"]:hover,
 a.sp-sponsor-button:hover, a.sp-sponsor-button:focus{
	color: {$colors['inverse_hover']};
	background-color: {$colors['text_dark']};
}

div .sp-template .sp-view-all-link > a:hover *,
div .sp-view-all-link > a:hover {
...
.sc_layouts_row_type_normal .sc_layouts_item a:not(.sc_button):not(.button):not(.elementor-button):hover,
.sc_layouts_row_type_normal .sc_layouts_item a:not(.sc_button):not(.button):not(.elementor-button):hover .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_normal .sc_layouts_item a:not(.sc_button):not(.elementor-button):not(.button):hover,
.scheme_self.sc_layouts_row_type_normal .sc_layouts_item a:not(.sc_button):not(.elementor-button):not(.button):hover .sc_layouts_item_icon {
	color: {$colors['text_dark']};
}
...
.sc_layouts_row_type_normal .scheme_self.sc_layouts_item .sc_layouts_item_icon{
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_hover']};
}

.sc_layouts_row_type_normal .sc_layouts_item_icon:hover,
.sc_layouts_row_type_normal .scheme_self.sc_layouts_item .sc_layouts_item_icon:hover,
.sc_layouts_row_type_normal .sc_layouts_item a:not(.sc_button):not(.button):not(.elementor-button):hover .sc_layouts_item_icon,
.sc_layouts_row_type_normal .scheme_self.sc_layouts_item a:not(.sc_button):not(.button):not(.elementor-button):hover .sc_layouts_item_icon {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.fcunited_tabs .fcunited_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
...
.sheme_self.sidebar .fcunited_tabs .fcunited_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
.sheme_self.sidebar div.esg-filter-wrapper .esg-filterbutton > span:hover,
.sheme_self.sidebar .mptt-navigation-tabs li a:hover,
.sheme_self.sidebar .fcunited_tabs .fcunited_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
...
.sheme_self.sidebar .fcunited_tabs .fcunited_tabs_titles li.ui-state-active a {
...
.post_info .post_info_item a.post_info_author:hover {
	color: {$colors['text_link']};
}
...
.post_featured.with_thumb .mejs-playpause-button > button,
.with_cover .mejs-playpause-button > button {
	background-color: {$colors['text_link']} !important;
}
...
.comments_list_wrap .comment_info .comment_label_author {
	color: {$colors['text_light']};
}
...
.scheme_self.sidebar .widget_recent_entries li,
.scheme_self.sidebar .widget_meta li,
...
.widget_rss .widget_title a:last-child:hover {
	color: {$colors['text_link']} !important;
}
...
.widget_display_search #bbp_search_submit, #bbpress-forums #bbp-search-form #bbp_search_submit {
	background-color: {$colors['text_link']};
}

.widget_search input.search-submit:hover, .woocommerce.widget_product_search .search_button:hover, 
.widget_display_search #bbp_search_submit:hover, #bbpress-forums #bbp-search-form #bbp_search_submit:hover {
	background-color: {$colors['text_hover']};
}
...
aside .socials_wrap .social_item .social_icon,
...
.extra-table table tr td h4 + p {
	color: {$colors['text_dark']};
}
.extra-table table tr td:first-child h4 + p {
	color: {$colors['text_link']};
}


.large-title h2 + .sc_item_descr,
.scheme_self.large-title h2 + .sc_item_descr {
	color: {$colors['text_dark']};
}
...
rs-module-wrap .post_meta .post_categories {
	background-color: {$colors['text_link']};
}
...
input:-webkit-autofill:active {
	-webkit-text-fill-color: {$colors['text_dark']};
}
...
.format-aside .post_content_inner a,
.format-link .post_content_inner a,
.format-status .post_content_inner a {
	color: {$colors['text_dark']};
}
.format-aside .post_content_inner a:hover,
.format-status .post_content_inner a:hover {
	color: {$colors['inverse_link']};
}
.format-link .post_content_inner a {
	color: {$colors['inverse_link']};
}
.format-link .post_content_inner a:hover {
	color: {$colors['text_dark']};
}
...
.comments_wrap .wpgdprc-checkbox label:before, input[type=radio] + label:before, 
.comments_wrap input[type=checkbox] + label:before, input[type=radio] + .wpcf7-list-item-label:before, 
.comments_wrap input[type=checkbox] + .wpcf7-list-item-label:before, 
.comments_wrap .wpcf7-list-item-label.wpcf7-list-item-right:before, 
.comments_wrap .edd_price_options ul > li > label > input[type=radio] + span:before, 
.comments_wrap .edd_price_options ul > li > label > input[type=checkbox] + span:before, 
.comments_wrap .trx_addons_popup_form_field_agree input[type=checkbox] + label:before,
...
CSS;
					...
					$rez            = apply_filters(
						'fcunited_filter_get_css', $rez, array(
							'colors' => $colors,
							'scheme' => $s,
						)
					);
		...
		return apply_filters( 'fcunited_filter_prepare_css', $css_str, $remove_spaces );
	}
}
