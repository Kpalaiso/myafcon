...
if ( ! function_exists( 'fcunited_trx_addons_add_theme_vars' ) ) {
	add_filter( 'fcunited_filter_add_theme_vars', 'fcunited_trx_addons_add_theme_vars', 10, 2 );
	function fcunited_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'fcunited_trx_addons_get_css' ) ) {
	add_filter( 'fcunited_filter_get_css', 'fcunited_trx_addons_get_css', 10, 2 );
	function fcunited_trx_addons_get_css( $css, $args ) {
