...
WordPress version: required at least 4.5, tested up to 6.0
...
Please install and activate it before starting to use the theme FC United.
...
Theme documentation is available on https://fc-united.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in FC United is Fontello.
